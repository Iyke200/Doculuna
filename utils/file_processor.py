...
async def process_file(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        max_size = 100 * 1024 * 1024 if user['is_premium'] else 50 * 1024 * 1024  # 100MB/50MB
        ...
        keyboard.append([InlineKeyboardButton("🔗 Merge with Other Files", callback_data="tool_merge")])
