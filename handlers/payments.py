...
‎from config import PREMIUM_DAYS_PER_PAYMENT
‎
...
‎            try:
‎                await update.callback_query.edit_message_text(
‎                    "🎉 Pro Unlocked! Enjoy watermark-free NYSC docs and unlimited conversions!"
‎                )
‎                await update.callback_query.answer()
‎                logger.info(f"Mock payment for user {user_id}, granted {days} days")
‎                break
‎            except RetryAfter as e:
