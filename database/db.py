...
def create_user(
    user_id, username=None, first_name=None, last_name=None, referred_by=None
):
...
def get_user_usage_stats(user_id):
    ...
    try:
        ...
        # Get user basic info
        cursor.execute(
            "SELECT usage_count, last_usage FROM users WHERE user_id = ?", (user_id,)
        )
        ...
        if user_result:
            ...
            return {"total_uses": 0, "today_uses": 0, "last_usage": None}
